...
from .profiling import reset_profiler, print_profiling_report
...
def run_scalability_test(
    ...
    if not psa.parameters:
        psa.parameters = {
            "cost_mult": {"distribution": "normal", "params": {"mean": 1.0, "std": 0.1}},
            "qaly_mult": {"distribution": "normal", "params": {"mean": 1.0, "std": 0.1}}
        }
