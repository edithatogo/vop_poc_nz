...
class TestCorrectedCEACalculations(unittest.TestCase):
    ...
    def test_run_cea_basic(self):
        ...
        expected_keys = [
            'perspective', 'cost_standard_care', 'qalys_standard_care',
            'cost_new_treatment', 'qalys_new_treatment', 'incremental_cost',
            'incremental_qalys', 'icer', 'incremental_nmb'
        ]
    ...
    def test_perspective_difference(self):
        ...
        self.assertNotEqual(
            hs_results['cost_new_treatment'], 
            s_results['cost_new_treatment']
        )
...
class TestValueOfInformation(unittest.TestCase):
    ...
    def test_probabilistic_sensitivity_analysis(self):
        ...
        psa = ProbabilisticSensitivityAnalysis(simple_model, params, wtp_threshold=50000)
...
class TestTransparencyFeatures(unittest.TestCase):
    ...
    def test_parameters_table_creation(self):
        ...
        expected_columns = ['Parameter', 'Value', 'Description', 'Source', 'Perspective']
