...
class TestNewFeatures(unittest.TestCase):
    ...
    def test_dsa_analysis(self):
        ...
        dsa_results_2_way = perform_comprehensive_two_way_dsa(self.interventions, wtp_threshold=50000, n_points=5)
        ...
        dsa_results_3_way = perform_three_way_dsa(self.interventions, wtp_threshold=50000, n_points=5)
    ...
    def test_discordance_analysis(self):
        ...
        discordance_results = calculate_decision_discordance("Test Intervention", self.test_params)
    ...
    def test_threshold_analysis(self):
        ...
        parameter_ranges = {
            'new_treatment_cost_multiplier': np.linspace(0.5, 1.5, 5)
        }
        threshold_results = run_threshold_analysis("Test Intervention", self.test_params, parameter_ranges)
        self.assertIn("new_treatment_cost_multiplier", threshold_results)
        self.assertIsInstance(threshold_results["new_treatment_cost_multiplier"], pd.DataFrame)
    ...
    def test_bia_model(self):
        ...
        bia_params = {
            ...
            'cost_per_patient': self.test_params['costs']['health_system']['new_treatment'][0],
            'offset_cost_per_patient': self.test_params['costs']['health_system']['standard_care'][0],
        }
